        ...
        <div className='contentDiv'>
          ...
          <div className='pageContent'>
            <Card className='blurbCard'>
              <span className='emphText'>
                {' '}
                WE BASE OUR SERVICE ON THREE CORE VALUES.
              </span>
              <span className='empthText'>
                Click the buttons below to see why should you use Bill's Signs
                as your next sign partner.
              </span>
              ...
              <Accordion defaultActiveKey='0' className='toggleButton'>
                <div className='contentDiv'>
                  ...
                  <Accordion.Toggle
                    ...
                    as={Card.Header}
                    eventKey='1'
                    className='emphText toggleButton'
                  >
                    QUALITY:
                  </Accordion.Toggle>
                  <Accordion.Collapse eventKey='1'>
                    <div className='cardText'>
                      Cheap signs can ruin your company's image. Our signs will
                      create and maintain a standard of professionalism.
                    </div>
                  </Accordion.Collapse>
                </div>
                <div className='contentDiv'>
                  ...
                  <Accordion.Collapse eventKey='2'>
                    <div className='cardText'>
                      Make an informed decision when buying your sign; 40 Years
                      of experience means we know how to help.
                    </div>
                  </Accordion.Collapse>
                </div>
                <div className='contentDiv'>
                  ...
                  <Accordion.Collapse eventKey='3'>
                    <div className='cardText'>
                      Our signs are built to last for years helping you get the
                      most ROI for your investment.
                    </div>
                  </Accordion.Collapse>
                </div>
              </Accordion>
            ...
            <Card className='d-flex justify-content-center bg-secondary text-white budgetCard'>
              <div className='blurbCard'>
                We specialize in creating the most effective product for each
                client. Contact us today and speak to one of our industry
                leading experts for information on:
          ...
          <a href='tel:850-576-6847' className='centerInDiv contentDiv'>
            <Button variant='danger' className='callButton'>
              Call Us Today
            </Button>
          </a>
        </div>
